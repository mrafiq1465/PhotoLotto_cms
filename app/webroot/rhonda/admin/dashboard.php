<?php if($_COOKIE['aamilog']!="1"){header( "Location: index.php");}?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="logout.php"><i class="icon-user"></i><span class="hidden-tablet"> logout</span></a></li>
					</ul>
